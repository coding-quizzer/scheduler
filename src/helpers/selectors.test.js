...
test("getInterview returns an object with the intereviewer data", () => {
...
test("getIntervewersForDay returns an array", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(Array.isArray(result)).toBe(true);
});

test("getInterviewerersForDay returns an array with a length matching the number of interviewers for that day", () => {
