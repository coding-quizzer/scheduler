...
const Appointment = (props) => {
  ...
  const cancel = () => {
    ...
    return (
      ...
      {mode === EDIT && <Form interviewers={interviewers} onCancel={back} onSave={save} interviewer={interviewer} setInterviewer={setInterviewer} student={student} setStudent={setStudent} />}
